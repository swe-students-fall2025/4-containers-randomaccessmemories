...
from app.storage import allowed_file, validate_file_size, save_audio_to_gridfs
from app.db import Database, get_recordings_collection, get_notes_collection
...
def test_save_audio_invalid_extension(mock_audio_file):
    """Test saving audio with invalid extension."""
    with pytest.raises(ValueError, match="not allowed"):
        save_audio_to_gridfs(mock_audio_file, "test.txt")
...
def test_save_and_retrieve_audio(mock_audio_file):
    ...
    # Retrieve file
    from app.storage import get_audio_from_gridfs
    ...
    # Cleanup
    from app.storage import delete_audio_from_gridfs
